...
class FrancaisViewController: UIViewController {
    ...
    func loadQuestionsFromFile() {
        ...
        if let filepath = Bundle.main.path(forResource: "questionsfrancais", ofType: "json") {
            do {
            ...
            print("Fichier 'questionsfrancais.json' introuvable.")
        }
    }
